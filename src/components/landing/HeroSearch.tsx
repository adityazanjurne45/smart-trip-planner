...
const HeroSearch = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto animate-fade-up" style={{ animationDelay: "0.3s" }}>
      ...
      <div className="relative">
        ...
        <div className="relative bg-card/95 backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-border/50 shadow-hero">
          {/* Quick Badge */}
            ...
            <div className="relative group">
              ...
              <div className={`relative transition-all duration-300 ${focusedField === 'from' ? 'scale-[1.02]' : ''}`}>
                ...
                <Input
                  ...
                  className="pl-12 h-14 rounded-xl bg-background/50 border-border/50 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-300"
                />
                {focusedField === 'from' && (
                  <div className="absolute inset-0 -z-10 bg-primary/5 rounded-xl blur-sm" />
                )}
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className={`relative transition-all duration-300 ${focusedField === 'to' ? 'scale-[1.02]' : ''}`}>
                ...
                <Input
                  ...
                  onBlur={() => setFocusedField(null)}
                  className="pl-12 h-14 rounded-xl bg-background/50 border-border/50 focus:border-accent focus:ring-2 focus:ring-accent/20 transition-all duration-300"
                />
                {focusedField === 'to' && (
                  <div className="absolute inset-0 -z-10 bg-accent/5 rounded-xl blur-sm" />
                )}
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className={`relative transition-all duration-300 ${focusedField === 'days' ? 'scale-[1.02]' : ''}`}>
                ...
                <Input
                  ...
                  onBlur={() => setFocusedField(null)}
                  className="pl-12 h-14 rounded-xl bg-background/50 border-border/50 focus:border-travel-forest focus:ring-2 focus:ring-travel-forest/20 transition-all duration-300"
                />
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className={`relative transition-all duration-300 ${focusedField === 'budget' ? 'scale-[1.02]' : ''}`}>
                ...
                <Input
                  ...
                  onBlur={() => setFocusedField(null)}
                  className="pl-12 h-14 rounded-xl bg-background/50 border-border/50 focus:border-travel-gold focus:ring-2 focus:ring-travel-gold/20 transition-all duration-300"
                />
              </div>
            </div>
          </div>
          ...
          <Button
            ...
            className="w-full h-14 text-lg font-semibold rounded-xl bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary text-primary-foreground shadow-hero hover:shadow-[0_25px_70px_-15px_hsl(var(--primary)/0.4)] hover:scale-[1.02] transition-all duration-300 group"
          >
